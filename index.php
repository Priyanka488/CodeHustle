        ...
        <!-- Page title -->
		 <section id="home-section" class="home-section full-screen" style="background-image: url('b2.jpg'); background-size:cover;">
            ...
            <div class="page-title-text wow fadeInUp">
            	...
            	<h1 style="font-size:500%;position:relative;bottom: 100px;"><font face="broadway" color="black"><b>CODE HUSTLE</b></h1><br>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 pricing-2 section-description wow fadeIn">
	                    ...
	                    <div class="divider-1 wow fadeInUp" > <span></span><font color=""><p>1. This is an online event and requires individual participation.<br>


                                                            2.  Every participant will have a different set of questions.<br>
                                                          3. The participants can code in either of the 4 languages- C,C++, JAVA and PYTHON.<br>

                                                            4.  Each question will be allotted marks and participant with the highest score will be declared the winner.
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 block-2 section-description wow fadeIn">
                        ...
                        Priyanka Yadav:0000xxxx00 &nbsp&nbsp
												<br>
												Harsh Joshi :0000xxxx00 &nbsp&nbsp
                        <br>
	                    </p>
	                </div>
	            </div>
